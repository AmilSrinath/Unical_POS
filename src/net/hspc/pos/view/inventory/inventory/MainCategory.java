...
import net.hspc.pos.controller.MainItemCategoryController;
...
public class MainCategory extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        mainItemCategoryTbl.setBackground(new java.awt.Color(0, 102, 153));
        mainItemCategoryTbl.setForeground(new java.awt.Color(255, 255, 255));
        mainItemCategoryTbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Main Category Name", "Is Active"
            }
        ) {
        ...
        jScrollPane1.setViewportView(mainItemCategoryTbl);
    ...
    private void jXButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jXButton1ActionPerformed
        MainItemCategoryDto mainItemCategoryDto=new MainItemCategoryDto(0, 
                nameTxt.getText(), selectedFilePath,statusChBox.isSelected());
...
//            java.util.logging.Logger.getLogger(MainCategory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new MainCategory().setVisible(true);
//            }
//        });
//    }
    ...
    private void loadAllCategories() {
        try {
            ArrayList<MainItemCategoryDto> allCategories=mainItemCategoryController.getAll();
