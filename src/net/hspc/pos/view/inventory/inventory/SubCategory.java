...
import net.hspc.pos.controller.SubItemCategoryController;
...
public class SubCategory extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        mainCategoryCmb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Main Category" }));
    ...
    private void jXButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jXButton1ActionPerformed
        SubItemCategoryDto subItemCategoryDto=new SubItemCategoryDto(0,
            0, mainCategoryCmb.getSelectedItem().toString(),subCatNameTxt.getText(),selectedFilePath,statusBox.isSelected());
