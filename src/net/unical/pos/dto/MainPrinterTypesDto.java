 ...
 * @author Sanjuka
 */
public class MainPrinterTypesDto {
    ...
    public MainPrinterTypesDto() {
    }

    public MainPrinterTypesDto(Integer printerTypeId, String name, Integer status, Integer userd, Integer visible) {
