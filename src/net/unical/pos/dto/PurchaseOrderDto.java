...
public class PurchaseOrderDto {
    ...
    public PurchaseOrderDto(Integer poId, String poPrefix, Integer poCode, String poCodePrefix, Integer supplierId, String supplierName, Date poDate, Date expectedDate, Double totalOrderPrice, Integer paymentType, Integer status, Integer userId, Integer visible) {
        this.poId = poId;
