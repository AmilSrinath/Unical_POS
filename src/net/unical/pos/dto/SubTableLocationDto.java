...
public class SubTableLocationDto {
    ...
    public SubTableLocationDto(Integer subTableLocationId, Integer mainTableLocationId, String mainName, String subName, String imagePath, Integer status, Integer userId, Integer visible) {
