...
public class MainItemCategoryModel implements SuperModel{
    ...
    public MainItemCategoryModel() {
    }

    public MainItemCategoryModel(Integer mainItemCategeryId, String categoryName, String imagePath, Integer status, Integer userId, Integer visible, Date createdDate, Integer editedBy, Date editedDate) {
