 ...
 * @author Sanjuka
 */
public class ItemWiseSalesReport extends javax.swing.JInternalFrame {
    ...
    public ItemWiseSalesReport(Dashboard dashboard) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            JasperDesign jasDesign = JRXmlLoader.load("./reports/ItemWise.jrxml");
            JasperReport jasReport = JasperCompileManager.compileReport(jasDesign);

            HashMap<String, Object> hm = new HashMap<>();
            hm.put("date1", fromDate);
            hm.put("date2", toDate);
            
            JasperPrint jasperPrint = JasperFillManager.fillReport(jasReport, hm,DBConnection.getInstance().getConnection());
            JasperViewer.viewReport(jasperPrint,false);
        } catch (JRException ex) {
            Logger.getLogger(ItemWiseSalesReport.class.getName()).log(Level.SEVERE, null, ex);
