...
public class SubCategory extends javax.swing.JInternalFrame {
    ...
    public SubCategory(Dashboard dashboard) {
        initComponents();
        ...
        subItemCategoryTbl.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            @Override
            public void valueChanged(ListSelectionEvent e) {
                if(subItemCategoryTbl.getSelectedRow()==-1){
                    update=false;
                    return;
                }
                
                String imagePath = Dashboard.configValues.get(Configurations.SE_IMAGE_PATH.getConfigValue())
                        +subItemCategoryTbl.getValueAt(subItemCategoryTbl.getSelectedRow(), 4);
                ...
                mainCategoryCmb.setSelectedItem(subItemCategoryTbl.getValueAt(subItemCategoryTbl.getSelectedRow(), 2));
                subCatNameTxt.setText((String) subItemCategoryTbl.getValueAt(subItemCategoryTbl.getSelectedRow(), 3));
            }
    ...
    private void initComponents() {
        ...
        subCatNameTxt = new org.jdesktop.swingx.JXTextField();
        ...
        subItemCategoryTbl = new org.jdesktop.swingx.JXTable();
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Add / Edit Sub Category", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 102, 153))); // NOI18N

        mainCategoryCmb.setBackground(new java.awt.Color(255, 255, 255));
        mainCategoryCmb.setForeground(new java.awt.Color(0, 0, 0));
        ...
        subCatNameTxt.setBackground(new java.awt.Color(255, 255, 255));
        subCatNameTxt.setForeground(new java.awt.Color(0, 0, 0));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(mainCategoryCmb, 0, 132, Short.MAX_VALUE)
                                .addComponent(subCatNameTxt, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(subCatNameTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Current Sub Categories", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 102, 153))); // NOI18N

        subItemCategoryTbl.setBackground(new java.awt.Color(255, 255, 255));
        subItemCategoryTbl.setForeground(new java.awt.Color(0, 0, 0));
        subItemCategoryTbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Sub Category Id", "Main Category Id", "Main Category Name", "Sub Category Name", "Image Path", "Is Active"
            }
        ) {
        ...
        jScrollPane1.setViewportView(subItemCategoryTbl);
        if (subItemCategoryTbl.getColumnModel().getColumnCount() > 0) {
            subItemCategoryTbl.getColumnModel().getColumn(0).setMinWidth(0);
            subItemCategoryTbl.getColumnModel().getColumn(0).setPreferredWidth(0);
            subItemCategoryTbl.getColumnModel().getColumn(0).setMaxWidth(0);
            subItemCategoryTbl.getColumnModel().getColumn(1).setMinWidth(0);
            subItemCategoryTbl.getColumnModel().getColumn(1).setPreferredWidth(0);
            subItemCategoryTbl.getColumnModel().getColumn(1).setMaxWidth(0);
            subItemCategoryTbl.getColumnModel().getColumn(4).setMinWidth(0);
            subItemCategoryTbl.getColumnModel().getColumn(4).setPreferredWidth(0);
            subItemCategoryTbl.getColumnModel().getColumn(4).setMaxWidth(0);
        }
    ...
    private void jXButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jXButton1ActionPerformed
        ...
        int index=mainCategoryCmb.getSelectedIndex();
        
        System.out.println(mainCategoryCmb.getSelectedIndex());
        SubItemCategoryDto subItemCategoryDto=new SubItemCategoryDto(0,
            mainCategoryIds.get(index), mainCategoryCmb.getSelectedItem().toString(),subCatNameTxt.getText(),
                selectedFilePath,activeStatus,dashboard.CREATED_USER_ID);
...
//    }
    ...
    private org.jdesktop.swingx.JXTextField subCatNameTxt;
    private org.jdesktop.swingx.JXTable subItemCategoryTbl;
    ...
    private void loadMainItemCategory() {
        try {
